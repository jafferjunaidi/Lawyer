...
<button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#staticBackdrop" id="#modalbutton">
  <i><b class="text-light">Customer Signup Modal</b></i>
  </button>
  </center>
      ...
      <div class="modal-content" >
        ...
        <div class="modal-body">
          ...
          <form method="post" enctype="multipart/form-data">
                ...
                <p class="text-center text-muted mt-4 mb-0">Already have an account? <a href="customerlogin.php"
...
if(isset($_POST['btnreg']))
{
  ...
  move_uploaded_file($tmp,"./customer_panel/pictures/" .$f);
  
  $insert=mysqli_query($con,"insert into customersignup values('null','$fn','$e','$p','$pn','$c','$f')");
...
echo "<meta http-equiv='refresh' content='2; url=customerlogin.php'>";
