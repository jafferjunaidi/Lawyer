...
if(isset($_POST['btnlogin']))
{
  ...
  $select=mysqli_query($con,"select * from adminsignup where Email='$e' and Password='$p'");

if(mysqli_num_rows($select))
{
 echo '<div class="alert alert-success alert-dismissible fade show mt-3" role="alert">
 <strong><center>Welcome Admin Login Successfully!!</center></strong>
 <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';

echo "<meta http-equiv='refresh' content='2; url=admin_panel/allappointments.php'>";
}
        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center text-warning mb-5"><span style="color: black;">sign in</span> <b>admin</b></h2>
         ...
         <label class="form-check-label" for="flexCheckDefault">Remember me</label>
                ...
                <!-- <p class="text-center text-muted mt-5 mb-0">Don't have an account? <a href="adminsignup.php"
