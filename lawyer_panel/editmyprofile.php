...
{
    $id=$_GET['A'];
    $slt=mysqli_query($con,"select * from lawyersignup where Id='$id'");
 ...
 <br>
   <?php
    ...
    { 
          ...
          move_uploaded_file($tmp, "../lawyer_panel/pictures/".$img);
            
          $update=mysqli_query($con,"update lawyersignup set Lawyer_name='$fn', Email='$e', Password='$p', CNIC='$cc', Phone_number='$pn', City='$c', Qualification='$q', Services='$s', Year_Experience='$exp', Pictures='$img'");
          if($update)
          {
            echo "
                                                          ...
                                                          <hr>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control" type="number" name="txtcnic" class="form-control mb-3" required>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control" type="text" name="txtq" class="form-control mb-3" required>
                                                                    </div>

                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">Services</p>
                                                                        <input class="form-control" type="text" name="txts" class="form-control mb-3" required>
                                                                    </div>
                                                                 </div>
                                                           ...
                                                           <div class="row">
                                                               <div class="col-sm-6">
                                                                       <p class="m-b-10 f-w-600">Year Experience</p>
                                                                       <input class="form-control" type="number" name="txtexp" class="form-control mb-3" required>
                                                                   </div>
