...
<?php
  $select=mysqli_query($con,"select * from adminsignup");
  $fetch=mysqli_fetch_assoc($select);
  
  if(mysqli_num_rows($select))
  {
   $_SESSION['n']= $fetch['Name'];
   $_SESSION['p']= $fetch['Picture'];
  }
?>
   ...
   <body class="dashboard dashboard_1">
      <div class="full_container">
         <div class="inner_container">
            ...
            <h2 class="mt-5 text-center text-uppercase">All appointments</h2>
<br>
<table class="table table-danger text-dark table-responsive">
         <thead>
             <tr>
                <th>Id</th>
                <th>Full name</th>
         ...
         <?php
          ...
          foreach($select as $data)
          {
            ...
            <td>$data[Status]</td>
            <td>
            <a class='btn btn-success' href='Approve.php' role='button'>Approve</a>
            </td>
            <td>
            <a class='btn btn-danger' href='Reject.php' role='button'>Reject</a>
            </td>
            </tr>
            ";
          }
