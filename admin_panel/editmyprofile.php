...
{
    $id=$_GET['A'];
    $slt=mysqli_query($con,"select * from adminsignup where Id='$id'");
            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <li class="active">
                     ...
                     <li class="active">
                        <a href="allcustomers.php" aria-expanded="false"><i class="fa fa-legal"></i> <span>All Customers</span></a>
                     </li>
                     
                     <li class="active">
                        <a href="alllawyers.php" aria-expanded="false"><i class="fa-solid fa-user-tie"></i> <span>All Lawyers</span></a>
                     </li>
 ...
 <br>
   <?php
    if(isset($_POST['btnupdate']))
    {
          ...
          move_uploaded_file($tmp, "../admin_panel/pictures/".$img);
            
          $update=mysqli_query($con,"update adminsignup set Name='$fn', Email='$e', Password='$p', Picture='$img'");
          if($update)
          {
            echo "
            <div class='alert alert-success alert-dismissible fade show' role='alert'>
            <center><strong>Admin Updated Successfully!!</strong></center>
            </div>";
          ...
          else
          {
            ...
            <center><strong>Admin not Updated.</strong></center>
            </div>";
          }
